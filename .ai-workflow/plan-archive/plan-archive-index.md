...
> 本文件用于索引已归档计划快照，路径规范：`.ai-workflow/plan-archive/<yyyy-mm>/<plan-id>.md`。
...
- PlanId: `PLAN-M19-2026-05-03`
  ...
  MilestoneSummary: `M19 进行中（Independent Physics Foundation，Engine.Physics 零 Engine 模块依赖、SceneData RigidBody/BoxCollider schema、PhysicsWorldDefinition fixed step、snapshot 与 AABB/ground query）`
...
- PlanId: `PLAN-M6-2026-04-17`
  Status: `Closed`
  LastUpdated: `2026-04-17 17:58`
  MilestoneSummary: `M6 完成（最小真实 MVP 渲染管线）`
...
- PlanId: `PLAN-M1M2-2026-04-08`
  Status: `Closed`
  LastUpdated: `2026-04-08 10:28`
  MilestoneSummary: `M1 完成（窗口+主循环）；M2 完成（清屏可视反馈）`
  SnapshotPath: `.ai-workflow/plan-archive/2026-04/PLAN-M1M2-2026-04-08.md`
